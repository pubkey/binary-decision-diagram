...
const find_similar_node_js_1 = require("./find-similar-node.js");
class AbstractNode {
    level;
    id = (0, util_js_1.nextNodeId)();
    deleted = false;
    type;
    rootNode;
 ...
 */
    ...
    nodesOfSameLevel) {
        ...
        const other = (0, find_similar_node_js_1.findSimilarNode)(this, nodesOfSameLevel);
        if (other) {
